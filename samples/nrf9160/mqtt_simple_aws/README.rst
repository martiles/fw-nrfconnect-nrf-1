...
nRF9160: Simple MQTT AWS
####################

The Simple MQTT AWS sample demonstrates how to easily connect an nRF9160 SiP to an AWS MQTT broker and send and receive data.

Overview
*********

The sample provisions the certificates in certificates.h and connects to an AWS MQTT broker and publishes whatever data it receives on the configured subscribe topic to the configured publish topic.
